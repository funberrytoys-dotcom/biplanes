...
const PLANE_ART_3D: { player: PlaneArtDef; enemy: PlaneArtDef; enemy2: PlaneArtDef } = {
  player: {
    ...
    columns: 5,
    fps: 24,
    cockpit: { x: 253, y: 136, h: 56 },
    bob: [[0.0, 0.0], [-0.0, -0.5], [-0.0, -1.0], [-0.1, -1.4], [-0.1, -1.9], [-0.1, -2.3], [-0.0, -2.7], [-0.0, -3.0], [0.0, -3.3], [0.0, -3.6], [0.1, -3.7], [0.1, -3.9], [0.2, -3.9], [0.2, -3.9], [0.3, -3.9], [0.3, -3.8], [0.4, -3.6], [0.4, -3.4], [0.5, -3.1], [0.5, -2.7], [0.6, -2.4], [0.7, -2.0], [0.7, -1.5], [0.7, -1.1], [0.8, -0.6], [0.8, -0.1], [0.8, 0.4], [0.8, 0.9], [0.8, 1.4], [0.8, 1.8], [0.8, 2.2], [0.8, 2.6], [0.8, 2.9], [0.8, 3.2], [0.8, 3.5], [0.7, 3.7], [0.7, 3.8], [0.6, 3.8], [0.6, 3.8], [0.5, 3.8], [0.5, 3.7], [0.4, 3.5], [0.4, 3.3], [0.3, 3.0], [0.2, 2.7], [0.2, 2.3], [0.1, 1.9], [0.1, 1.4], [0.1, 1.0], [0.0, 0.5]],
  },
  enemy: {
    ...
    columns: 5,
    fps: 24,
    cockpit: { x: 258, y: 133, h: 62 },
    bob: [[0.0, 0.0], [-0.0, -0.5], [-0.1, -1.0], [-0.1, -1.4], [-0.1, -1.9], [-0.1, -2.3], [-0.0, -2.7], [-0.0, -3.0], [0.0, -3.3], [0.1, -3.5], [0.1, -3.7], [0.1, -3.8], [0.2, -3.9], [0.3, -3.9], [0.3, -3.8], [0.4, -3.7], [0.4, -3.5], [0.5, -3.2], [0.6, -2.9], [0.6, -2.6], [0.7, -2.2], [0.8, -1.8], [0.8, -1.3], [0.9, -0.9], [0.9, -0.4], [0.9, 0.1], [1.0, 0.6], [1.0, 1.1], [1.0, 1.6], [1.0, 2.0], [1.0, 2.4], [1.0, 2.8], [0.9, 3.1], [0.9, 3.4], [0.9, 3.7], [0.8, 3.8], [0.8, 3.9], [0.7, 4.0], [0.7, 4.0], [0.6, 3.9], [0.6, 3.8], [0.5, 3.6], [0.4, 3.4], [0.4, 3.1], [0.3, 2.7], [0.2, 2.3], [0.2, 1.9], [0.1, 1.5], [0.1, 1.0], [0.0, 0.5]],
  },
